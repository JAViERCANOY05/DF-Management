    ...
    <Box sx={{ display: "flex" }}>
      ...
      <Box component="main" sx={{ flexGrow: 1, p: 3 }}>
        ...
        <div className=" flex justify-center  ">
          <p className=" border-2 p-5 w-96 text-2xl rounded-md font-bold text-center bg-blue-500 text-white ">
            Notifications
          </p>
        </div>
        <div className=" flex justify-center ">
          <div className=" flex gap-20 border-2 px-60  mt-40 py-10  rounded-md bg-slate-400 ">
            <div>
              <p className=" p-4  bg-red-500 rounded-md font-bold">No Data</p>
